...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_textColor, Color.YELLOW);
        textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize, 50);
        roundWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_roundWidth, 1);
...
//        Log.e("log", centre + "");
        ...
        paint.setAntiAlias(true);  //消除锯齿
        canvas.drawCircle(centre, centre, radius - 1, paint); //画出圆环
